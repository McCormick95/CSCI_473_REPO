...
def create_3d_plot(H, A, Z, title, filename, z_label):
...
def generate_graphs(input_filename):
    ...
    create_3d_plot(H_mesh, A_mesh, Z_t, 'Transmission Rate vs H and A', 'transmission_3d.png',"T/n" )
    create_3d_plot(H_mesh, A_mesh, Z_a, 'Absorption Rate vs H and A', 'absorption_3d.png', "A/n")
    create_3d_plot(H_mesh, A_mesh, Z_r, 'Reflection Rate vs H and A', 'reflection_3d.png',"R/n")

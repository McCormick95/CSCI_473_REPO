...
int main(int argc, char** argv) {
    ...
    exchange_row_striped_matrix_halo((void **)A2, MPI_DOUBLE, rows2, cols2, MPI_COMM_WORLD);
    ...
    write_row_striped_matrix_halo(argv[3], (void**)A2, MPI_DOUBLE, rows2, cols2, MPI_COMM_WORLD);
